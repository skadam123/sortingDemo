...
public class SortDataModel {
   ...
   *
   * @param orignalInput the new orignal input
   */
   ...
   *
   * @param timeTakenToSort the new time taken to sort
   */
   ...
   *
   * @param sortedArray the new sorted array
   */
   ...
   *
   * @param swapTracking the new swap tracking
   */
  ...
  public String toString() {
    return String.format(
        "SortDataModel [id=%s, orignalInput=%s, timeTakenToSort=%s, sortedArray=%s, swapTracking=%s]",
        id, orignalInput, timeTakenToSort, sortedArray, swapTracking);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (orignalInput == null) {
      if (other.orignalInput != null) return false;
    } else if (!orignalInput.equals(other.orignalInput)) return false;
    if (sortedArray == null) {
      if (other.sortedArray != null) return false;
    } else if (!sortedArray.equals(other.sortedArray)) return false;
    if (swapTracking == null) {
      if (other.swapTracking != null) return false;
    } else if (!swapTracking.equals(other.swapTracking)) return false;
    if (timeTakenToSort == null) {
      if (other.timeTakenToSort != null) return false;
    } else if (!timeTakenToSort.equals(other.timeTakenToSort)) return false;
    return true;
  }
